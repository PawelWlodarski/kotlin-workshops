...
object Intro3AnswersLibrary {
    ...
    object InMemoryDatabase : Database {
        ...
        override fun get(id: ProductId): Mono<ProductRecord> = TODO("EXERCISE 1 - use 'data' object ")
    ...
    object Handler {
        ...
        fun handle(r: Request): Mono<Response> = TODO("EXERCISE 2")


        //PART 3
        fun handleEvent(r:Request): Mono<Response> = TODO("EXERCISE 3")
