...
class IntroSpring4Exercises {
    ...
    class NamedContext{
        ...
        fun <T : Any> findNamed(name:String):T? = TODO()

        inline fun <reified T : Any> findOptional():Option<T> = TODO()

        fun <T : Any> findOptional(c:Class<T>):Option<T> = TODO()
    }
